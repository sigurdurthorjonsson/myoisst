...
pdf(file = "sst_jul_2010-2018.pdf")
print(
d %>% 
  ggplot() +
  theme_bw() +
...
dev.off()
system("convert -density 250x250 sst_jul_2010-2018.pdf sst_jul_2010-2018.png")
...
pdf(file="sst_jul_2010-2018_anomaly_ref_1990-2009.pdf")
print(
d %>%
  ggplot() +
...
dev.off()
system("convert -density 250x250 sst_jul_2010-2018_anomaly_ref_1990-2009.pdf sst_jul_2010-2018_anomaly_ref_1990-2009.png")
