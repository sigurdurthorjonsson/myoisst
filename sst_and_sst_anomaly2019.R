...
# repeated in August 2019 for the 2019-report, after some experimenting
library(raster)
library(tidyverse)
...
pdf(file = "sst_jul_2010-2019.pdf")
print(
d %>% 
  ggplot() +
  theme_bw() +
...
dev.off()
system("convert -density 250x250 sst_jul_2010-2019.pdf sst_jul_2010-2019.png")
...
pdf(file="sst_jul_2010-2019_anomaly_ref_1990-2009.pdf")
print(
d %>%
  ggplot() +
...
dev.off()
system("convert -density 250x250 sst_jul_2010-2019_anomaly_ref_1990-2009.pdf sst_jul_2010-2019_anomaly_ref_1990-2009.png")
